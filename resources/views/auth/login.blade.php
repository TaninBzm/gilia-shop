...
<main class="bg--white" style="background-color: white;">
    <div class="container" >
        ...
        <form class="sign-page__form" action="{{ route('login.store') }}" method="POST">
            ...
            <a class="recover-password" href="{{ route('password.request') }}" style="margin-bottom: 20px;">بازیابی رمز عبور</a>
            <button class="btn btn-primary width-100" type="submit">ورود به سایت</button>
            <div class="sign-page__footer" style="margin-top: 20px;">
